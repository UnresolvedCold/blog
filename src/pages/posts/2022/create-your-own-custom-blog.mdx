...
1. Create an account on [Porkbun](https://porkbun.com/) and buy a domain of your liking.
...
1. In the next steps, it will ask you to update `A` and `TXT` records with your domain provider which is [porkbun](https://porkbun.com/) in our case.
