...
In our company, we were having multiple maven projects that were dependent on each other. 
...
author Shubham Kumar (Product Architecture) <shubham.kumar@greyorange.com> 1670872587 +0530     # Commit time remained unchanged
committer Shubham Kumar (Product Architecture) <shubham.kumar@greyorange.com> 1670872587 +0530  
