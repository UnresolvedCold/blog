...
And include the remotes of our repository we want to merge. 
...
Now, of course we never want to manually redo this for all the repos and for all the branches.
