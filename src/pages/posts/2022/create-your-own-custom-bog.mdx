...
import UseGithubTemplate from "@images/2022/create-your-own-custom-blog/use-github-template.png"
...
Click `Use this template` -> `Create a new repository`. This will help you to create a new repository using the template.
